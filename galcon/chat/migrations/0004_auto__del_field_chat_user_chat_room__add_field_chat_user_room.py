...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Chat_User.chat_room'
        db.delete_column('chat_chat_user', 'chat_room_id')

        # Adding field 'Chat_User.room'
        db.add_column('chat_chat_user', 'room',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='users', null=True, to=orm['chat.Room']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Chat_User.chat_room'
        db.add_column('chat_chat_user', 'chat_room',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='users', null=True, to=orm['chat.Room'], blank=True),
                      keep_default=False)

        # Deleting field 'Chat_User.room'
        db.delete_column('chat_chat_user', 'room_id')
