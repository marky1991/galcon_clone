...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('galcon_section', 'title', self.gf('django.db.models.fields.CharField')(max_length=101))

    def backwards(self, orm):

        # Changing field 'Section.title'
        db.alter_column('galcon_section', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'galcon.section': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "''", 'max_length': '100'}),
            'title': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '101'})
        },
        'galcon.subsection': {
