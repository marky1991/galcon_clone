...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Join_Group_Request.recipient'
        db.alter_column('galcon_join_group_request', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['galcon.Player']))

    def backwards(self, orm):

        # Changing field 'Join_Group_Request.recipient'
        db.alter_column('galcon_join_group_request', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['galcon.Group']))
