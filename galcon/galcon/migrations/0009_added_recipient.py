...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pm.recipient'
        db.add_column('galcon_pm', 'recipient',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='recieved_messages', to=orm['galcon.Player']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pm.recipient'
        db.delete_column('galcon_pm', 'recipient_id')
    ...
    models = {
        ...
        'galcon.friend_request': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sent_friend_request'", 'to': "orm['galcon.Player']"}),
            'hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'friend_request'", 'to': "orm['galcon.Player']"})
        },
        'galcon.group': {
            'Meta': {'object_name': 'Group'},
            'admins': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'admined_groups'", 'blank': 'True', 'to': "orm['galcon.Player']"}),
        ...
        'galcon.join_group_request': {
            ...
            'accepted': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sent_join_group_request'", 'to': "orm['galcon.Player']"}),
            'hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'join_group_request'", 'to': "orm['galcon.Player']"})
        },
        'galcon.note': {
        ...
        'galcon.pm': {
            'Meta': {'object_name': 'Pm'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sent_messages'", 'to': "orm['galcon.Player']"}),
            'hidden': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'galcon.post': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "''", 'max_length': '100'}),
            'text': ('django.db.models.fields.TextField', [], {'max_length': '65000'}),
            'title': ('django.db.models.fields.TextField', [], {'default': "'(Blank)'", 'max_length': '100'})
        },
        'galcon.rank': {
