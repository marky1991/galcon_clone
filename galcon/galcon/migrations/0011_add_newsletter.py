...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.get_newsletter'
        db.add_column('galcon_player', 'get_newsletter',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.get_newsletter'
        db.delete_column('galcon_player', 'get_newsletter')
