...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('groups_membership', (
            ...
            ('player', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['galcon.Player'])),
        ...
        db.delete_table(db.shorten_name('groups_group_admins'))
    ...
    def backwards(self, orm):
        ...
        m2m_table_name = db.shorten_name('groups_group_admins')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('group', models.ForeignKey(orm['groups.group'], null=False)),
            ('player', models.ForeignKey(orm['galcon.player'], null=False))
