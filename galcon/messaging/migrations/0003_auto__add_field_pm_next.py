...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pm.next'
        db.add_column('messaging_pm', 'next',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='previous', unique=True, null=True, to=orm['messaging.Pm']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pm.next'
        db.delete_column('messaging_pm', 'next_id')
