...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('messaging_pm', 'recipient_id')

        # Deleting field 'Pm.author'
        db.delete_column('messaging_pm', 'author_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column('messaging_pm', 'recipient',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='recieved_messages', to=orm['galcon.Player']),
                      keep_default=False)

        # Adding field 'Pm.author'
        db.add_column('messaging_pm', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='written_messages', to=orm['galcon.Player']),
                      keep_default=False)
