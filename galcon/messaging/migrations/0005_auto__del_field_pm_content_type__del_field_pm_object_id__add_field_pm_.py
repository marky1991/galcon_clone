...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Pm.content_type'
        db.delete_column('messaging_pm', 'content_type_id')

        # Deleting field 'Pm.object_id'
        db.delete_column('messaging_pm', 'object_id')

        # Adding field 'Pm.author_content_type'
        db.add_column('messaging_pm', 'author_content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=5, related_name='a', to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Pm.author_object_id'
        db.add_column('messaging_pm', 'author_object_id',
    ...
    def backwards(self, orm):
        # Adding field 'Pm.content_type'
        db.add_column('messaging_pm', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=5, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Pm.object_id'
        db.add_column('messaging_pm', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Pm.author_content_type'
        db.delete_column('messaging_pm', 'author_content_type_id')

        # Deleting field 'Pm.author_object_id'
        db.delete_column('messaging_pm', 'author_object_id')
    ...
    models = {
        ...
        'messaging.pm': {
            'Meta': {'object_name': 'Pm'},
            'author_content_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'a'", 'to': "orm['contenttypes.ContentType']"}),
            'author_object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'next': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'previous'", 'unique': 'True', 'null': 'True', 'to': "orm['messaging.Pm']"}),
            'post_date': ('django.db.models.fields.DateTimeField', [], {}),
            'read': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'recipient_content_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'b'", 'to': "orm['contenttypes.ContentType']"}),
            'recipient_object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
